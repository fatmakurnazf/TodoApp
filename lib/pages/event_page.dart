...
final List<Event> _eventList = [
  new Event("08:00", "Gönderilen Sunumlar düzenlenilecek","", true),
  new Event("10:00", "Yeni bir toplantı ayarlanılacak", "iş", true),
  new Event("12:00", "Projenin taslak halinin oluşturulması", "ekip", false),
  new Event("14:00", "Taslağın ilgili yerlere gönderilmesi", "iş", false),
  new Event("16:00", "Faturaların ödenmesi", "Kişisel", false),
  new Event("18:00", "Yeni kullanıcıların düzenlenmesi", "iş", false),
];
